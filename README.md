...
✅ **End-to-end pipeline shipped (v0.8.0).**
...
**208/208 tests** green (138 unit + 8 cross-tenant + 6
...
serve full CRUD on the per-tenant YAML; **`PUT /config/rules`
hot-swaps the router via `arc_swap` — no extension restart
needed when operators edit routing rules**.
